...
- [x] Project: Localization
- [x] copy issues from zer0Kerbal/Localization
- [x] assign to zer0Kerbal
- [x] assign projects (user and repo)
- [x] assign label: localization
- [x] assign label: help-wanted
